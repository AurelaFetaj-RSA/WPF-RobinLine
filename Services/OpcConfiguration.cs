namespace WPF_App.Services
{
    ...
    public class RobinLineOpcConfiguration : OpcConfiguration
    {
        public RobinLineOpcConfiguration()
        {
            ...
            AddNode("Oven1Temperature", "ns=2;s=Tags.Eren_robin/pc_temperatura_forno_primer", typeof(int), true);
            ...
            AddNode("Oven1TempSetpoint", "ns=2;s=Tags.Eren_robin/pc_setpoint_temperatura_forno_primer", typeof(int));
            ...
            AddNode("Oven2Temperature", "ns=2;s=Tags.Eren_robin/pc_temperatura_forno_colla", typeof(int), true);
            ...
            AddNode("Oven2TempSetpoint", "ns=2;s=Tags.Eren_robin/pc_setpoint_temperatura_forno_colla", typeof(int));
